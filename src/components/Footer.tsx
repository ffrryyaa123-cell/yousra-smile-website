...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-slate-950 text-slate-100 border-t border-slate-800 transition-colors pt-12 sm:pt-16 pb-10 sm:pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 sm:gap-10 pb-10 sm:pb-12 border-b border-slate-800">
          ...
          <div className="lg:col-span-2 space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm font-medium text-white">{t.footerBrandBio}</p>
              </div>
            </div>

            <p className="text-base font-medium text-slate-100 leading-8">
            ...
            <button
              ...
              aria-label={language === 'ar' ? `تواصل معنا عبر الموقع: ${contactEmail}` : `Contact us on the website: ${contactEmail}`}
            >
          ...
          <div className="space-y-4">
            <h3 className="text-base font-black text-white uppercase tracking-wider font-['Tajawal']">{t.categories}</h3>
              ...
              {categories.map(cat => (
                <li key={cat.id}>
                  <button
                    ...
                    className="min-h-10 hover:text-amber-200 transition-colors flex items-center gap-1.5 text-white text-start"
                  >
          ...
          {/* Legal & Static Links */}
          <div className="space-y-4">
            <h3 className="text-base font-black text-white uppercase tracking-wider font-['Tajawal']">{t.importantLinks}</h3>
            <ul className="space-y-2.5 text-base font-semibold text-white">
              <li>
          ...
          {/* Newsletter Box */}
          <div className="space-y-4">
            <h3 className="text-base font-black text-white uppercase tracking-wider font-['Tajawal']">{t.newsletterTitle}</h3>
            <p className="text-sm font-medium text-slate-100 leading-7">
              {t.newsletterDesc}
            </p>
            ...
            <div className="pt-2 flex items-center gap-2 text-sm font-medium text-slate-100 leading-6">
        ...
        <div className="py-6 border-b border-slate-800/80 text-base font-medium text-slate-100 leading-8 text-center sm:text-right">
        ...
        {/* Copyright Notice */}
        <div className="pt-8 flex flex-col sm:flex-row justify-between items-center gap-4 text-sm font-medium text-slate-100 text-center sm:text-start">
