...
export const AgentAutomationHub: React.FC = () => {
  ...
  const handleSaveUrlCampaignToStore = () => {
    ...
    const newProd: Product = {
      ...
      description: urlCampaignResult.seoDescription || urlCampaignResult.productTitleEn || '',
      longDescription: `${urlCampaignResult.seoDescription || ''}\n\nالمميزات:\n${urlCampaignResult.features?.join('\n') || ''}`,
      originalPrice: Number(urlCampaignResult.originalPrice) || 0,
      discountPrice: Number(urlCampaignResult.discountPrice) || 0,
      discountPercent: Number(urlCampaignResult.discountPercent) || 0,
      currency: urlCampaignResult.currency || 'USD',
      rating: 0,
      reviewCount: 0,
      viewsCount: 0,
      ...
      brand: urlCampaignResult.brand || '',
      features: urlCampaignResult.features || [],
      specs: {},
      image: urlCampaignResult.image || '',
      images: urlCampaignResult.images || [],
      amazonUrl: urlCampaignResult.affiliateLink || urlProductInput,
      youtubeUrl: urlCampaignResult.suggestedVideoUrl || undefined,
      isFeatured: true,
      isTopSelling: true,
      isActive: true,
