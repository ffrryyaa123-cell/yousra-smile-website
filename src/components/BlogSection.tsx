...
import { BookOpen, Clock, ArrowLeft, ArrowRight, User } from 'lucide-react';
...
export const BlogSection: React.FC = () => {
  ...
  return (
    <section className="py-12 px-4 sm:px-6 bg-slate-950/60 border-y border-slate-800/80 font-['Cairo']">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-8 gap-4">
          <div>
            ...
            <p className="text-xs sm:text-sm text-slate-400 mt-1">
              {language === 'ar'
                ? 'مقارنات حقيقية ونصائح لاختيار أفضل الأجهزة والحلول المنزلية بكل ثقة'
                : 'Practical comparisons and shopping tips for smart-home and lifestyle products'}
            </p>
          </div>
        </div>
