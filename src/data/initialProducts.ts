...
export const INITIAL_PRODUCTS: Product[] = [
  {
    id: 'prod-tineco-s9-station-scientist-pro',
    titleAr: 'مكنسة تينيكو FLOOR ONE Station S9 Scientist Pro مع محطة تعبئة ذكية سعة 5 لتر',
    titleEn: 'Tineco Floor ONE Station S9 Scientist Pro Vacuum Mop with 5L Water Storage',
    description: 'مكنسة شفط وغسل للأرضيات الصلبة بمحطة تعبئة ذكية سعة 5 لتر، وشفط 25 كيلو باسكال، وتنظيف ذاتي بالهواء الساخن خلال 5 دقائق.',
    descriptionEn: 'A wet dry floor washer with a 5L Smart Refresh Station, 25kPa suction, and 5-minute hot-air self-cleaning.',
    longDescription: 'تجمع مكنسة Tineco FLOOR ONE Station S9 Scientist Pro بين الشفط والغسل في تمريرة واحدة على الأرضيات الصلبة المغلقة. تتيح محطة التعبئة الذكية سعة 5 لتر إعادة التعبئة بلمسة واحدة لتنظيف المنزل كاملاً دون توقف، بينما يزيل نظام HydroBurst مع شفط 25 كيلو باسكال دهون المطبخ والبقع الجافة والانسكابات اللاصقة. ويضبط ممسحة StreakFree الذكية نفسها مع كل حركة دفع وسحب لإزالة الماء الزائد والخطوط، ثم ينظّف النظام نفسه ذاتياً بهواء ساخن بدرجة 230°F ويجفّف الفرشاة والفلتر خلال 5 دقائق. يصل زمن التشغيل إلى 100 دقيقة، مع شحن سريع وشاشة Pixel Light وإضاءة أمامية وتطبيق ذكي.',
    longDescriptionEn: 'The Tineco FLOOR ONE Station S9 Scientist Pro vacuums and mops sealed hard floors in a single pass. Its 5L Smart Refresh Station auto-refills at one touch for uninterrupted whole-home cleaning, while HydroBurst cleaning with 25kPa suction lifts kitchen grease, dried spills and everyday messes. The Smart-Sensing StreakFree scraper adjusts on every push and pull to remove excess water and streaks, and 5-Minute FlashDry self-cleaning washes and dries the roller and filter with 230°F hot air. Up to 100 minutes of runtime, plus Flash Charging, a Pixel Light Display, an LED headlight and a smart app.',
    category: 'smart-home',
    subcategory: 'مكانس شفط وغسل للأرضيات',
    subcategoryEn: 'Household Wet-Dry Vacuums',
    brand: 'Tineco',
    image: 'https://m.media-amazon.com/images/I/61zyPjyvN0L._AC_SL1500_.jpg',
    images: [
      'https://m.media-amazon.com/images/I/61zyPjyvN0L._AC_SL1500_.jpg',
      'https://m.media-amazon.com/images/I/71GRlCskWQL._AC_SL1500_.jpg',
      'https://m.media-amazon.com/images/I/81+JEj4WraL._AC_SL1500_.jpg',
      'https://m.media-amazon.com/images/I/81uF4L7j2GL._AC_SL1500_.jpg',
      'https://m.media-amazon.com/images/I/81OqjhGZknL._AC_SL1500_.jpg',
      'https://m.media-amazon.com/images/I/81t4cXadwGL._AC_SL1500_.jpg',
      'https://m.media-amazon.com/images/I/712eVA+VGVL._AC_SL1500_.jpg',
      'https://m.media-amazon.com/images/I/81XNsJVlsuL._AC_SL1500_.jpg',
      'https://m.media-amazon.com/images/I/81EECtofwLL._AC_SL1500_.jpg'
    ],
    amazonUrl: 'https://amzn.to/4gSLWWG',
    originalPrice: 685.56,
    discountPrice: 685.56,
    discountPercent: 0,
    currency: 'USD',
    rating: 4.0,
    reviewCount: 1,
    features: [
      'محطة تعبئة ذكية سعة 5 لتر مع إعادة تعبئة تلقائية بلمسة واحدة لتنظيف المنزل كاملاً دون توقف',
      'تنظيف HydroBurst مع شفط قوي 25 كيلو باسكال يزيل دهون المطبخ والبقع الجافة والانسكابات اللاصقة',
      'ممسحة StreakFree ذكية تضبط نفسها مع كل دفع وسحب لإزالة الماء الزائد والخطوط',
      'تنظيف ذاتي FlashDry خلال 5 دقائق بهواء ساخن 230°F يغسل الفرشاة والأنابيب ثم يجففها',
      'زمن تشغيل يصل إلى 100 دقيقة مع شحن سريع وشاشة Pixel Light وإضاءة LED وتطبيق ذكي'
    ],
    featuresEn: [
      'Smart Refresh Station with 5L Water Storage – one-touch auto refills for uninterrupted whole-home cleaning',
      'HydroBurst Cleaning with 25kPa powerful suction for grease, dried spills and everyday messes',
      'Smart-Sensing StreakFree Scraper adjusts on every push and pull to remove excess water and streaks',
      '5-Minute FlashDry Self-Cleaning with 230°F hot air washes and dries the roller and filter',
      'Up to 100 minutes runtime with Flash Charging, Pixel Light Display, LED headlight and smart app'
    ],
    specs: {
      'العلامة التجارية': 'Tineco',
      'الطراز': 'Floor One Station S9 Scientist Pro',
      'قوة الشفط': '25 كيلو باسكال',
      'سعة محطة التعبئة': '5 لتر',
      'سعة الخزان': '0.8 لتر',
      'زمن التشغيل': 'ساعة و40 دقيقة',
      'نوع الفلتر': 'فلتر HEPA',
      'مصدر الطاقة': 'بطارية قابلة للشحن',
      'اللون': 'أسود',
      'الوزن': '31 رطلاً',
      'طريقة التحكم': 'تطبيق ولمس',
      'الأسطح المناسبة': 'أرضيات صلبة، خشب، لامينيت، متعددة الأسطح',
      'الاستخدام': 'داخلي',
      'المرفقات': 'فلتر جاف، فرشاة دوارة، قاعدة تجفيف وشحن، أداة تنظيف',
      'رقم المنتج (ASIN)': 'B0GVJ8VWRG'
    },
    specsEn: {
      'Brand': 'Tineco',
      'Model': 'Floor One Station S9 Scientist Pro',
      'Suction': '25kPa',
      'Station Capacity': '5 liters',
      ...
      'Included Components': 'Dry Filter, Brush Roller, Drying & Charging Dock, Cleaning Tool',
      'ASIN': 'B0GVJ8VWRG'
    },
    keywords: ['Tineco', 'Floor ONE Station S9', 'مكنسة شفط وغسل', 'wet dry vacuum', 'مكنسة تينيكو', 'تنظيف الأرضيات', '25kPa'],
    isFeatured: true,
    isLatest: true,
    viewsCount: 0,
