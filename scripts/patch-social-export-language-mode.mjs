...
const replaceRequired = (needle, replacement, label) => {
  if (!source.includes(needle)) {
    throw new Error(`[patch-social-export-language-mode] Missing ${label}`);
  }
...
console.log('[patch-social-export-language-mode] Social export now strictly follows the selected Arabic/English mode.');
